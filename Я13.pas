...
for i in range(10):
    ...
    if player1_value > player2_value:
        print("player 1 wins-->You can listen Angra music")
        player1_score = player1_score + 1  # This is how we increment a variable
    elif player2_value > player1_value:
        print("player 2 wins-->You can listen Stratovarius  music")
        player2_score = player2_score + 1
    else:
        print("It's a draw-->Listen both Angra and Stratovarius music")
    ...
    if player2_value > player3_value:
        print("player 2 wins-->You can listen Angra music")
    ...
    if player4_value > player3_value:
        print("player 4 wins-->You can listen Angra music")
        player4_score = player3_score + 1  # This is how we increment a variable
    elif player4_value > player3_value:
        print("player 4 wins-->You can listen Stratovarius music")
        player2_score = player2_score + 1
    else:
        print("It's a draw-->Listen both Angra and Stratovarius music")
